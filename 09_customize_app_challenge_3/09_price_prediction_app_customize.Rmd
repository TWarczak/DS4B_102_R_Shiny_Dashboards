...
# Scripts
source(here::here("00_scripts", "02_process_data.R"))
source(here::here("00_scripts", "03_make_predictions.R"))
source(here::here("09_customize_app_challenge_3", "plot_bike_prediction_cannondale.R"))

# Model
model_xgboost <- read_rds(here::here("00_models", "model_xgboost.rds"))
```
...
renderImage({
  ...
  # new_bike_tbl <- generate_new_bike(bike_model = "F-Si",
  #                                   category_1 = "Mountain",
  #                                   category_2 = "Cross Country Race",
